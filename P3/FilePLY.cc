...
int FilePLY::open(char *File_name)
{
...
int FilePLY::create(char *File_name)
{
...
int FilePLY::
read(vector<vert> &Vertices,vector<cara> &Faces)
{
int Next_token,i,j;
...
//int FilePLY::write(vector<float> &Vertices,vector<int> &Faces)
//{
...
void FilePLY::error(const char *Error)
{
...
int FilePLY::is_number(char *Aux_token)
{
char *p1;
...
int FilePLY::search_token(char *Aux_token)
{
int i=0;
